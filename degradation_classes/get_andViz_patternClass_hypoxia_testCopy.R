...
####### get color scheme
paired_hl_hypoxia <- c("#33A02C", "#1F78B4", "#6A3D9A", "#E31A1C")
# show_col(paired_hl_hypoxia)
...
############## test session
# test1 <- raw_norm2zero_hypoxia[!(rownames(raw_norm2zero_hypoxia) %in% rownames(raw_norm2zero_hypoxia_RAIcut)), ]
...
norm2zero_hypoxia_CDS_log2 %>%
        ...
        geom_line(aes(group = Pattern_cls_hypoxia, color = Pattern_cls_hypoxia), alpha = 0.5,
...
ggsave("./plots_degradationPattern/CDS_degradationPattern_complete_hypoxia.png", width = 30, height = 20, units = "cm", dpi = 600)
...
ggsave("./plots_degradationPattern/CDS_degradationPattern_leadered_complete_hypoxia.png", width = 30, height = 20, units = "cm", dpi = 600)
...
ggsave("./plots_degradationPattern/CDS_degradationPattern_leaderless_complete_hypoxia.png", width = 30, height = 20, units = "cm", dpi = 600)

####### get dendrogram of first round clustering
###### relative to T0
hcdata_norm2zero <- dendro_data_k(hc_norm2zero, 4)
paired_norm2zero <- c("#999999", "#1F78B4", "#6A3D9A", "#E31A1C", "#33A02C")
plot_ggdendro(hcdata_norm2zero,
              ...
              expand.y    = 0) +
        theme_void()
ggsave("./plots_degradationPattern/CDS_degradationHierarchicalClustering_complete_hypoxia.png", width = 30, height = 20, units = "cm", dpi = 600, bg = "white")
